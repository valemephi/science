...
c
      ...
      if ( b .eq. 0.0D+00 .or. b .eq. - int ( abs ( b ) ) ) then
        chg = dcmplx ( 1.0D+30, 0.0D+00 )
      else if ( a .eq. 0.0D+00 .or. z .eq. 0.0D+00 ) then
        chg = dcmplx ( 1.0D+00, 0.0D+00 )
...
10          continue
            ...
            ba = b - a
            call gamma ( ba, g3 )
            cs1 = dcmplx ( 1.0D+00, 0.0D+00 )
            cs2 = dcmplx ( 1.0D+00, 0.0D+00 )
            cr1 = dcmplx ( 1.0D+00, 0.0D+00 )
            cr2 = dcmplx ( 1.0D+00, 0.0D+00 )
...
10      continue
      ...
      if ( y .eq. 0.0D+00 ) then
        ...
        cs = cos ( 2.0D+00 * x * y )
        ss = sin ( 2.0D+00 * x * y )
        er1 = dble ( exp ( - x2 ) * ( 1.0D+00 - cs ) 
     &    / ( 2.0D+00 * pi * x ) )
        ei1 = exp ( - x2 ) * ss / ( 2.0D+00 * pi * x )
        er2 = 0.0D+00
        do n = 1, 100
          er2 = dble ( 
     &      er2 + exp ( - 0.25D+00 * n * n ) 
...
20      continue
        ...
        err = dble ( er0 + er1 + c0 * er2 )
        ei2 = 0.0D+00
        do n = 1, 100
          ei2 = dble ( ei2 + exp ( - 0.25D+00 * n * n ) 
     &      / ( n * n + 4.0D+00 * x2 ) * ( 2.0D+00 * x
...
10      continue
        ...
        it = it + 1
        call cerf ( z, zf, zd )
        zp = dcmplx ( 1.0D+00, 0.0D+00 )
        do i = 1, nr - 1
          zp = zp * ( z - zo(i) )
        end do
        zfd = zf / zp
        zq = dcmplx ( 0.0D+00, 0.0D+00 )
        do i = 1, nr - 1
          zw = dcmplx ( 1.0D+00, 0.0D+00 )
          do j = 1, nr - 1
            if ( j .ne. i ) then
              zw = zw * ( z - zo(j) )
            end if
...
c
     ...
     &            -6.0384407670507D+02,-3.3022722944809D+03/
      ...
      if ( a0 .eq. 0.0D+00 ) then
        cbi0 = dcmplx ( 1.0D+00, 0.0D+00 )
        cbi1 = dcmplx ( 0.0D+00, 0.0D+00 )
        cdi0 = dcmplx ( 0.0D+00, 0.0D+00 )
        cdi1 = dcmplx ( 0.5D+00, 0.0D+00 )
        cbk0 = dcmplx ( 1.0D+30, 0.0D+00 )
        cbk1 = dcmplx ( 1.0D+30, 0.0D+00 )
        cdk0 = - dcmplx ( 1.0D+30, 0.0D+00 )
        cdk1 = - dcmplx ( 1.0D+30, 0.0D+00 )
        return
      end if
...
c
      ...
      if ( a0 .lt. 1.0D-100 ) then
        do k = 0, n
          cbi(k) = dcmplx ( 0.0D+00, 0.0D+00 )
          cdi(k) = dcmplx ( 0.0D+00, 0.0D+00 )
          cbk(k) = - dcmplx ( 1.0D+30, 0.0D+00 )
          cdk(k) = dcmplx ( 1.0D+30, 0.0D+00 )
        end do
        cbi(0) = dcmplx ( 1.0D+00, 0.0D+00 )
        cdi(1) = dcmplx ( 0.5D+00, 0.0D+00 )
        return
      end if
      ...
      cf2 = dcmplx ( 0.0D+00, 0.0D+00 )
      cf1 = dcmplx ( 1.0D-30, 0.0D+00 )
      do k = m, 0, -1
...
c
     ...
     &             -0.4406481417852278D+14,0.6065091351222699D+16/
      ...
      if ( a0 .eq. 0.0D+00 ) then
        cbj0 = dcmplx ( 1.0D+00, 0.0D+00 )
        cbj1 = dcmplx ( 0.0D+00, 0.0D+00 )
        cdj0 = dcmplx ( 0.0D+00, 0.0D+00 )
        cdj1 = dcmplx ( 0.5D+00, 0.0D+00 )
        cby0 = - dcmplx ( 1.0D+30, 0.0D+00 )
        cby1 = - dcmplx ( 1.0D+30, 0.0D+00 )
        cdy0 = dcmplx ( 1.0D+30, 0.0D+00 )
        cdy1 = dcmplx ( 1.0D+30, 0.0D+00 )
        return
      end if
...
c
      ...
      if ( a0 .lt. 1.0D-100 ) then
        do k = 0, n
          cbj(k) = dcmplx ( 0.0D+00, 0.0D+00 )
          cdj(k) = dcmplx ( 0.0D+00, 0.0D+00 )
          cby(k) = - dcmplx ( 1.0D+30, 0.0D+00 )
          cdy(k) = dcmplx ( 1.0D+30, 0.0D+00 )
        end do
        cbj(0) = dcmplx ( 1.0D+00, 0.0D+00 )
        cdj(1) = dcmplx ( 0.5D+00, 0.0D+00 )
        return
      end if
...
10    continue
      ...
      ch2 = dcmplx ( 1.0D+00, 0.0D+00 )
      ch1 = dcmplx ( 0.0D+00, 0.0D+00 )
      lb0 = lb
      do k = lb, 1, -1
      ...
      cp12 = ch0
      cp22 = ch2
      ch2 = dcmplx ( 0.0D+00, 0.0D+00 )
      ch1 = dcmplx ( 1.0D+00, 0.0D+00 )
      do k = lb, 1, -1
        ch0 = 2.0D+00 * k / z * ch1 - ch2
        ch2 = ch1
        ch1 = ch0
...
c
     ...
     &             -0.1993531733751297D+01,0.2724882731126854D+02/
      ...
      if ( a0 .le. 300.0D+00 .or. 80 .lt. n ) then
        ...
        cbs = dcmplx ( 0.0D+00, 0.0D+00 )
        csu = dcmplx ( 0.0D+00, 0.0D+00 )
        csv = dcmplx ( 0.0D+00, 0.0D+00 )
        cf2 = dcmplx ( 0.0D+00, 0.0D+00 )
        cf1 = dcmplx ( 1.0D-30, 0.0D+00 )
...
10        continue
        ...
        do j = 0, 1
          ...
          cpz = dcmplx ( 1.0D+00, 0.0D+00 )
          crp = dcmplx ( 1.0D+00, 0.0D+00 )
          do k = 1, k0
            crp = - 0.78125D-02 * crp 
     &        * ( vv - ( 4.0D+00 * k - 3.0D+00 ) ** 2 )
     &        * ( vv - ( 4.0D+00 * k - 1.0D+00 ) ** 2 ) 
     &        / ( k * ( 2.0D+00 * k - 1.0D+00 ) * z2 )
          ...
          cqz = dcmplx ( 1.0D+00, 0.0D+00 )
          crq = dcmplx ( 1.0D+00, 0.0D+00 )
          do k = 1, k0
            crq = -0.78125D-02 * crq 
     &        * ( vv - ( 4.0D+00 * k - 1.0D+00 ) ** 2 ) 
     &        * ( vv - ( 4.0D+00 * k + 1.0D+00 ) ** 2 )
...
20          continue
          ...
          cs0 = dcmplx ( 0.0D+00, 0.0D+00)
          w0 = 0.0D+00
          cr0 = dcmplx ( 1.0D+00, 0.0D+00 )
          do k = 1, 30
            w0 = w0 + 1.0D+00 / k
...
c
      ...
      do i = 0, n
        do j = 0, m
          cpm(j,i) = dcmplx ( 0.0D+00, 0.0D+00 )
          cpd(j,i) = dcmplx ( 0.0D+00, 0.0D+00 )
        end do
      end do

      cpm(0,0) = dcmplx ( 1.0D+00, 0.0D+00 )
      ...
      if ( abs ( x ) .eq. 1.0D+00 .and. y .eq. 0.0D+00 ) then
        ...
        do j = 1, n
          do i = 1, m
            if ( i .eq. 1 ) then
              cpd(i,j) = dcmplx ( 1.0D+30, 0.0D+00 )
            else if ( i .eq. 2 ) then
              cpd(i,j) = -0.25D+00 
     &          * ( j + 2 ) * ( j + 1 ) * j * ( j - 1 ) * x ** ( j + 1 )
            end if
     ...
     &      - ( i + j - 1.0D+00 ) * cpm(i,j-2) ) / ( j - i )
      ...
      cpd(0,0) = dcmplx ( 0.0D+00, 0.0D+00 )
      do j = 1, n
...
c
      ...
      cpn(0) = dcmplx ( 1.0D+00, 0.0D+00 )
      cpn(1) = z
      cpd(0) = dcmplx ( 0.0D+00, 0.0D+00 )
      cpd(1) = dcmplx ( 1.0D+00, 0.0D+00 )
...
c
      ...
      if ( abs ( x ) .eq. 1.0D+00 .and. y .eq. 0.0D+00 ) then
        do i = 0, m
          do j = 0, n
            cqm(i,j) = dcmplx ( 1.0D+30, 0.0D+00 )
            cqd(i,j) = dcmplx ( 1.0D+30, 0.0D+00 )
          end do
        end do
        return
      end if
     ...
     &      * int ( - 1.0D+00 - 1.8D+00 * log ( xc - 1.0D+00 ) )
        ...
        cqf2 = dcmplx ( 0.0D+00, 0.0D+00 )
        cqf1 = dcmplx ( 1.0D+00, 0.0D+00 )
        do k = km, 0, -1
...
c
      ...
      if ( z .eq. 1.0D+00 ) then
        do k = 0, n
          cqn(k) = dcmplx ( 1.0D+30, 0.0D+00 )
          cqd(k) = dcmplx ( 1.0D+30, 0.0D+00 )
        end do
        return
      end if
...
c
      ...
      if ( a0 .lt. 1.0D-60 ) then
        ...
        csj(0) = dcmplx ( 1.0D+00, 0.0D+00 )
        cdj(1) = dcmplx ( 0.333333333333333D+00, 0.0D+00 )
        return
      end if
...
10      continue
        ...
        if ( x .le. 0.0D+00 .and. dimag ( z ) .eq. 0.0D+00 ) then
          ce1 = ce1 - pi * dcmplx ( 0.0D+00, 1.0D+00 )
        end if
...
10        continue
          ...
          if ( abs ( c - a - b - mcab ) .lt. eps ) then
            ...
            zf0 = dcmplx ( 1.0D+00, 0.0D+00 )
            zr0 = dcmplx ( 1.0D+00, 0.0D+00 )
            zr1 = dcmplx ( 1.0D+00, 0.0D+00 )
            sp0 = 0.0D+00
            sp = 0.0D+00
